...
SELECT 
    CASE 
        ...
        ELSE CONCAT_WS(', ', m.surname, m.firstname)
    END AS member_name,
...
FROM Bookings b
JOIN Facilities f ON b.facid = f.facid
LEFT JOIN Members m ON b.memid = m.memid AND b.memid != 0
WHERE b.starttime LIKE '2012-09-14%'
  AND (
      (b.memid != 0 AND f.membercost * b.slots > 30) OR
